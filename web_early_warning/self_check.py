...
from web_early_warning.inference_service import ScoreRequest, health, score


def main() -> int:
    ap = argparse.ArgumentParser(description="Smoke-check the Web Threat Early Warning scoring bundle + policy.")
    ap.add_argument(
        "--force-alert",
        action="store_true",
